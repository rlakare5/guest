...
function App() {
  ...
  const handleConfirm = () => {
    // Redirect to next page or handle confirmation
    console.log('Booking confirmed:', formData)
    alert('Booking confirmed! Redirecting to next page...')
    setShowPopup(false)
    // Here you can add navigation to next page
    // window.location.href = '/confirmation' or use React Router
  }
